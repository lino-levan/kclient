...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const profileRaw = await fetch("https://www.khanacademy.org/api/internal/graphql/getFullUserProfile", {
  ...
  const avatarRaw = await fetch("https://www.khanacademy.org/api/internal/graphql/avatarDataForProfile", {
